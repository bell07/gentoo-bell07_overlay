...
if [[ ${PV} == 9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/pythonlover02/DXVK-Sarek"
else
	HASH_SPIRV=ce9dfb01496073a02d74581ae909384763b41ff8
	HASH_VULKAN=afe9eb980aa928a66d1c9c06f38c55dd59868720
	SRC_URI="
		https://github.com/pythonlover02/DXVK-Sarek/archive/refs/tags/v${PV}.tar.gz
			-> ${P}.tar.gz
...
src_prepare() {
	...
	cp -- "${DISTDIR}"/setup_dxvk.sh ./setup_dxvk.sh || die
...
multilib_src_install_all() {
	newbin setup_dxvk.sh setup_dxvk_sarek.sh
...
pkg_postinst() {
	if [[ ! ${REPLACING_VERSIONS} ]]; then
		...
		elog
		elog "	WINEPREFIX=/path/to/prefix setup_dxvk_sarek.sh install --symlink"
		elog
		elog "See ${EROOT}/usr/share/doc/${PF}/README.md* for details."
		elog "Note: setup_dxvk_sarek.sh is unofficially temporarily provided as it was"
